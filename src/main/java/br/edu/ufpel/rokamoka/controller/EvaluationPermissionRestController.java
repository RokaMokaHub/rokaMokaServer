...
public class EvaluationPermissionRestController extends RokaMokaController {

    private final IEvaluationPermissionService evaluationPermissionService;

    @PostMapping("/deny/{permissionId}")
    public ResponseEntity<ApiResponseWrapper<Void>> deny(
            @PathVariable Long permissionId,
            @RequestBody EvaluationPermissionDTO evaluationDTO,
    ...
    public ResponseEntity<ApiResponseWrapper<Void>> accept(
            @PathVariable Long permissionId,
            Authentication authentication) {
