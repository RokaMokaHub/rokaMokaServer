...
CREATE TABLE public.dispostivo (
    id int8 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    user_id int8 NULL,
    device_id varchar(255) NOT NULL,
    CONSTRAINT dispostivo_pkey PRIMARY KEY (id)
);


-- public.dispostivo chaves estrangeiras

ALTER TABLE public.dispostivo ADD CONSTRAINT fk_usuario FOREIGN KEY (user_id) REFERENCES public.usuario(id);
